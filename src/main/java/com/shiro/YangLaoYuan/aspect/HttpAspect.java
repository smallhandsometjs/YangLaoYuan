package com.shiro.YangLaoYuan.aspect;
...
import com.shiro.YangLaoYuan.service.OperatingRecordService;
import com.shiro.YangLaoYuan.service.PermissionService;
...
public class HttpAspect extends BaseApi{
    ...
    @Pointcut("execution(public * com.shiro.YangLaoYuan.api..*(..))")
    public void log() {
     ...
     * @date: 2017/12/15
     */
    @Around("execution(* com.shiro.YangLaoYuan.api..*(..)) && args(..,bindingResult)")
